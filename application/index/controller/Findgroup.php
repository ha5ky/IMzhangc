...
class Findgroup extends Base
{
    ...
    public function index()
    {
        ...
        $groupArr = db('chatgroup')->where('status = 1')->order('id desc')->limit(4)->select();
    ...
    public function addGroup()
    {
        ...
        return $this->fetch('findgroup/addgroup');
    }
    /**
     * 上传图片方法
     * @param $param
    ...
    public function search(){
     ...
     // echo $groupName;die();
     $find = db('chatgroup')->where('group_name' ,$groupName)->select();
     // dump($find);die();
     if( empty($find) ){
    ...
    public function myGroup()
    {
        ...
        return $this->fetch('findgroup/mygroup');
    }
    //移出成员出组
